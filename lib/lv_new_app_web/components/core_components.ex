defmodule LvNewAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvNewAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvNewAppWeb.Gettext, "errors", msg, opts)
    end
  end
